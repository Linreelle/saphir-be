                ...
                .authorizeHttpRequests(
                        auth ->
                                auth
                                        ...
                                        .requestMatchers(HttpMethod.GET,"offers/healthcheck").hasAnyAuthority(ADMIN_READ.name(), MANAGER_READ.name())
                                        .requestMatchers(HttpMethod.GET, "/offers/all").hasAuthority(ADMIN_READ.name())
